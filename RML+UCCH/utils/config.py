...
#### data parameters ####
#########################
parser.add_argument("--data_name", type=str, default="mirflickr25k_fea",  # mirflickr25k_fea nus_wide_tc10_fea
                    help="data name")
...
parser.add_argument('--bit', type=int, default=16, help='output shape')   # 16 32 64 128
